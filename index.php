...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $basePath; ?>pages/tohru.css">
    <link rel="icon" type="image/png" href="<?php echo $basePath; ?>tohru.png">
    <?php
    require_once 'pages/config.php';

    $page = $_GET['i'] ?? 'home';
    $allowed_pages = ['home', 'quotes', 'tips', 'stuff', 'images', 'audio'];
...
<body>
    <div class="container">
        <header>
            ...
            <p>I know this UI sucks ass, but it's better than no UI.</p>
        </header>
